...
run_rl_pipeline() {
    ...
    python arsq_rlb/runner/train_rlbench_sqar.py \
       ...
       agent.use_fk_reg=True \
       wandb.name="arsq-Eikonal_${TARGET_TASK}_CQN_AS" \
       seed=0
...
# EXECUTE TASKS
# ==========================================
run_rl_pipeline "press_switch"
#run_rl_pipeline "put_rubbish_in_bin"
